...
SITEST_SRCS := $(SITEST_SRC) $(PROTO_SRC)
...
$(DIST)/test-obj/%.o: %.c $(HDRS) $(SITEST_HDR) | $(DIST)
	@mkdir -p $(dir $@)
...
$(TEST_TARGET): $(TEST_PROTOCOL_SRCS) $(SITEST_LIB) src/protocol/protocol.h $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) -o $@ $(TEST_PROTOCOL_SRCS) $(SITEST_LIB) $(LDFLAGS)

$(TEST_SERVER_PEERS_TARGET): $(TEST_SERVER_PEERS_SRCS) $(SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) -o $@ $(TEST_SERVER_PEERS_SRCS) $(SITEST_LIB) $(LDFLAGS)

$(TEST_SERVER_DATA_TARGET): $(TEST_SERVER_DATA_SRCS) $(SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) -o $@ $(TEST_SERVER_DATA_SRCS) $(SITEST_LIB) $(LDFLAGS)

$(TEST_SERVER_HANDLERS_TARGET): $(TEST_SERVER_HANDLERS_SRCS) $(SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) -o $@ $(TEST_SERVER_HANDLERS_SRCS) $(SITEST_LIB) $(LDFLAGS)

$(TEST_CLIENT_PEERS_TARGET): $(TEST_CLIENT_PEERS_SRCS) $(SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) -o $@ $(TEST_CLIENT_PEERS_SRCS) $(SITEST_LIB) $(LDFLAGS)

$(TEST_CLIENT_HANDLERS_TARGET): $(TEST_CLIENT_HANDLERS_SRCS) $(SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) -o $@ $(TEST_CLIENT_HANDLERS_SRCS) $(SITEST_LIB) $(LDFLAGS)
...
$(DIST)/test-obj-sanitize/%.o: %.c $(HDRS) $(SITEST_HDR) | $(DIST)
	@mkdir -p $(dir $@)
...
$(SAN_TEST_TARGET): $(TEST_PROTOCOL_SRCS) $(SAN_SITEST_LIB) src/protocol/protocol.h $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) $(SAN_FLAGS) -o $@ $(TEST_PROTOCOL_SRCS) $(SAN_SITEST_LIB) $(LDFLAGS) $(SAN_FLAGS)

$(SAN_SERVER_PEERS_TARGET): $(TEST_SERVER_PEERS_SRCS) $(SAN_SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) $(SAN_FLAGS) -o $@ $(TEST_SERVER_PEERS_SRCS) $(SAN_SITEST_LIB) $(LDFLAGS) $(SAN_FLAGS)

$(SAN_SERVER_DATA_TARGET): $(TEST_SERVER_DATA_SRCS) $(SAN_SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) $(SAN_FLAGS) -o $@ $(TEST_SERVER_DATA_SRCS) $(SAN_SITEST_LIB) $(LDFLAGS) $(SAN_FLAGS)

$(SAN_SERVER_HANDLERS_TARGET): $(TEST_SERVER_HANDLERS_SRCS) $(SAN_SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) $(SAN_FLAGS) -o $@ $(TEST_SERVER_HANDLERS_SRCS) $(SAN_SITEST_LIB) $(LDFLAGS) $(SAN_FLAGS)

$(SAN_CLIENT_PEERS_TARGET): $(TEST_CLIENT_PEERS_SRCS) $(SAN_SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) $(SAN_FLAGS) -o $@ $(TEST_CLIENT_PEERS_SRCS) $(SAN_SITEST_LIB) $(LDFLAGS) $(SAN_FLAGS)

$(SAN_CLIENT_HANDLERS_TARGET): $(TEST_CLIENT_HANDLERS_SRCS) $(SAN_SITEST_LIB) $(HDRS) $(SITEST_HDR) | $(DIST)
	$(CC) $(CFLAGS) $(INCLUDES) $(SAN_FLAGS) -o $@ $(TEST_CLIENT_HANDLERS_SRCS) $(SAN_SITEST_LIB) $(LDFLAGS) $(SAN_FLAGS)
